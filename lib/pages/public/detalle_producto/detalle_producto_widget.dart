...
class _DetalleProductoWidgetState extends State<DetalleProductoWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<ProductosRecord>(
      stream: ProductosRecord.getDocument(widget.productoRef!),
        ...
        return GestureDetector(
          ...
          child: Scaffold(
            ...
            appBar: AppBar(
              ...
              title: Text(
                detalleProductoProductosRecord.nombre,
                ...
                children: [
                  Container(
                    ...
                    child: ClipRRect(
                      ...
                      child: Image.network(
                        detalleProductoProductosRecord.imagen,
                        width: MediaQuery.sizeOf(context).width * 1.0,
                  ...
                  Row(
                    ...
                    children: [
                      Text(
                        detalleProductoProductosRecord.precio.toString(),
                        style: FlutterFlowTheme.of(context).bodyMedium.override(
                              fontFamily: 'Readex Pro',
                              fontSize: 20.0,
                            ),
                      ...
                      child: Row(
                        ...
                        children: [
                          FFButtonWidget(
                            onPressed: () async {
                              setState(() {
                                FFAppState().addToCarrito(widget.productoRef!);
                              });
                              setState(() {
                                FFAppState().sumaProductos =
                                    FFAppState().sumaProductos +
                                        detalleProductoProductosRecord.precio
                                            .toDouble();
                              });
                              setState(() {
                                FFAppState().Fecha = getCurrentTimestamp;
                              });
