...
import 'productos_update_model.dart';
export 'productos_update_model.dart';

class ProductosUpdateWidget extends StatefulWidget {
  const ProductosUpdateWidget({
    Key? key,
  ...
  @override
  _ProductosUpdateWidgetState createState() => _ProductosUpdateWidgetState();
}

class _ProductosUpdateWidgetState extends State<ProductosUpdateWidget> {
  late ProductosUpdateModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProductosUpdateModel());
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<ProductosRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ProductosRecord> productosUpdateProductosRecordList =
            snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final productosUpdateProductosRecord =
            productosUpdateProductosRecordList.isNotEmpty
                ? productosUpdateProductosRecordList.first
                : null;
                          ...
                          onPressed: () async {
                            await queryCategoriaRecordOnce(
                              queryBuilder: (categoriaRecord) =>
                                  categoriaRecord.where('idcat',
                                      isEqualTo: _model.drpCategoriasValue),
                              singleRecord: true,
                            ...
                            await ProductosRecord.collection
                                ...
                                .set(createProductosRecordData(
                                  ...
                                  imagen: FFAppState().imagetemporal,
