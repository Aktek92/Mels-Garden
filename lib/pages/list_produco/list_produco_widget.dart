...
import 'list_produco_model.dart';
export 'list_produco_model.dart';

class ListProducoWidget extends StatefulWidget {
  const ListProducoWidget({
    Key? key,
  ...
  @override
  _ListProducoWidgetState createState() => _ListProducoWidgetState();
}

class _ListProducoWidgetState extends State<ListProducoWidget> {
  late ListProducoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ListProducoModel());
  }
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<CategoriaRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final listProducoCategoriaRecord = snapshot.data!;
                    ...
                    child: StreamBuilder<List<ProductosRecord>>(
                      stream: queryProductosRecord(
                        queryBuilder: (productosRecord) => productosRecord
                            .where('Categoria',
                                isEqualTo: listProducoCategoriaRecord.reference)
                            .orderBy('Precio'),
                      ),
                      builder: (context, snapshot) {
                        // Customize what your widget looks like when it's loading.
