...
class CrearProductoWidget extends StatefulWidget {
  ...
  @override
  _CrearProductoWidgetState createState() => _CrearProductoWidgetState();
}
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<ProductosRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ProductosRecord> crearProductoProductosRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final crearProductoProductosRecord =
            crearProductoProductosRecordList.isNotEmpty
                ? crearProductoProductosRecordList.first
                : null;
            ...
            body: SafeArea(
              ...
              child: Column(
                ...
                children: [
                  ...
                  StreamBuilder<List<CategoriaRecord>>(
                    stream: queryCategoriaRecord(
                      queryBuilder: (categoriaRecord) => categoriaRecord
                          .where('idcat', isEqualTo: _model.drpCategoriasValue),
                      singleRecord: true,
                    ),
                    builder: (context, snapshot) {
                      // Customize what your widget looks like when it's loading.
                      ...
                      List<CategoriaRecord> btnCrearCategoriaRecordList =
                          snapshot.data!;
                      // Return an empty Container when the item does not exist.
                      if (snapshot.data!.isEmpty) {
                        return Container();
                      }
                      final btnCrearCategoriaRecord =
                          btnCrearCategoriaRecordList.isNotEmpty
                              ? btnCrearCategoriaRecordList.first
                              : null;
                        ...
                        onPressed: () async {
                          ...
                          await ProductosRecord.collection
                              ...
                              .set(createProductosRecordData(
                                codigo: _model.txtCodigoController.text,
                                ...
                                categoria: btnCrearCategoriaRecord?.reference,
                              ));
                          await showDialog(
                            context: context,
