...
class ListaPedidosWidget extends StatefulWidget {
  const ListaPedidosWidget({
    Key? key,
    this.productos,
  }) : super(key: key);

  final List<DocumentReference>? productos;
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<ProductosRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ProductosRecord> listaPedidosProductosRecordList = snapshot.data!;
                                      ...
                                      children: [
                                        StreamBuilder<UsersRecord>(
                                          ...
                                          builder: (context, snapshot) {
                                            ...
                                            final txtUsuarioUsersRecord =
                                                snapshot.data!;
                                            return Text(
                                              'Usuario:${txtUsuarioUsersRecord.email}',
                                              style:
                                        ...
                                        Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  0.0, 5.0, 0.0, 0.0),
                                          child: Text(
                                            'Fecha del pedido: ${listViewCarritoRecord.fecha?.toString()}',
